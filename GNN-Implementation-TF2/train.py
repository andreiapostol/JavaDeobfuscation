...
def run(args):
    ...
    model_cls, additional_model_params = name_to_model_class(args['MODEL_NAME']) # ia parametrii de la gnn (in cazul nostru)
    ...
    task_params = task_cls.default_params() # seteaza niste proprietati gen 'add_self_loop_edges': True etc
    task_params.update(additional_task_params)
    model_params = model_cls.default_params()
    model_params.update(additional_model_params) # updateaza cu aditionalii, {} by default
